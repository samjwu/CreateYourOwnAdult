...
var adultOutcome4_1 = {
    description: "You feel a little better.",
    callback: function() {setup.changeCoreStats(0, 0, 0)}
};
var adultOutcome4_2 = {
    description: "Bad idea. Try not to abuse your body when you're feeling down.\n \
        You feel a little weaker in <span class='blue'>mind</span> and <span class='green'>body</span>.",
    callback: function() {setup.changeCoreStats(-1, -1, 0)}
};
...
var adultOutcome5_1 = {
    description: "Do you even lift, bro?\n \
        Yes. You do.\n \
        You become a bit <span class='green'>weaker</span> due to your injury, but you get some <span class='red'>cred</span> for lifting.",
    callback: function() {setup.changeCoreStats(-1, 0, 1)}
};
var adultOutcome5_2 = {
    description: "Do you even lift, bro?\n \
        No. You do not. Boxes don't count.\n \
        You become a bit <span class='green'>weaker</span> due to your injury and you gain no cred for lifting boxes.",
    callback: function() {setup.changeCoreStats(-1, 0, 0)}
};
var adultOutcome5_3 = {
    description: "You got hurt while running. That's too bad.\n \
        You become a bit <span class='green'>weaker</span> due to your injury, but at least it was because you were <span class='blue'>smart</span> enough to exercise.",
    callback: function() {setup.changeCoreStats(-1, 1, 0)}
};
var adultOutcome5_4 = {
    description: "A bar fight?\n \
        That's a pretty <span class='blue'>dumb</span> reason for getting hurt.\n \
        You become a bit <span class='green'>weaker</span> due to your injury.",
    callback: function() {setup.changeCoreStats(-1, -1, 0)}
};
...
var seniorOutcome3_1 = {
    description: "Good question. I'm not really sure either.",
    callback: function() {setup.changeCoreStats(0, 0, 0)}
};
var seniorOutcome3_2 = {
    description: "Your grandkids get the idea that you have no idea what the idea is behind a meme.\n \
        They're still happy that you tried, though.\n \
        They <span class='red'>like</span> you a bit more.",
    callback: function() {setup.changeCoreStats(0, 0, 1)}
};
var seniorOutcome3_3 = {
    description: "The future is now, old man.\n \
        You need to get with the times before they leave you <span class='blue'>behind</span>.",
    callback: function() {setup.changeCoreStats(0, -1, 0)}
};

var seniorOutcome4_1 = {
    description: "Hm. Well, whatever.",
    callback: function() {setup.changeCoreStats(0, 0, 0)}
};
...
var adultEvent4 = {
    description: "You just had a bad day.\n\n\
        You're taking one down.\n\n\
        What do you do to turn it around?\n",
    options: new Map([
        ["Sing a sad song", adultOutcome4_1],
        ["Work at a smile", adultOutcome4_1],
        ["Go for a ride", adultOutcome4_1],
        ["Drink some alcohol", adultOutcome4_2],
        ["Eat some junk food", adultOutcome4_2],
...
var adultEvent5 = {
    description: "Uh oh! You just got injured!\n\n\
        What were you doing?\n",
    options: new Map([
        ["Lifting weights", adultOutcome5_1],
        ["Lifting boxes", adultOutcome5_2],
        ["Running", adultOutcome5_3],
...
var seniorEvent3 = {
    description: "Your grandkids are visiting and share some memes with you.\n\n\
        What do you do?\n",
    options: new Map([
        ["What in tarnation is a 'meem'?", seniorOutcome3_1],
        ["Politely smile and nod", seniorOutcome3_2],
        ["'Back in my day, we told jokes the old-fashioned way, without all these fancy doodads!'", seniorOutcome3_3]
    ])
};
var seniorEvent4 = {
    description: "You noticed that you are starting to forget...\n\n\
        ...what was I talking about?\n",
    options: new Map([
        ["What?", seniorOutcome4_1],
        ["I don't know", seniorOutcome4_1],
        ["I forget", seniorOutcome4_1],
